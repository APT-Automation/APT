...
public class APT_DomainManagementTest extends DriverTestcase{
	...
	public void DomainManagementService(Map<String, String> map) throws Exception {
		...
		logger= ExtentTestManager.startTest ("verifycreateorder - Domain Management");
		...
		logger= ExtentTestManager.startTest ("verifyservicetypeselection - Domain Management");
		APT_DomainManageHelper.get().verifyselectservicetype("DomainManagementservice", map.get("ServiceType"));
		ExtentTestManager.endTest();
		
		logger= ExtentTestManager.startTest ("verifyservicecreation - Domain Management");
		...
		logger= ExtentTestManager.startTest ("verifyCustomerDetailsInformation - Domain Management");
		...
		logger= ExtentTestManager.startTest ("verifyorderpanelinviewservicepage - Domain Management");
		...
		logger= ExtentTestManager.startTest ("verifyservicepanelInformation - Domain Management");
