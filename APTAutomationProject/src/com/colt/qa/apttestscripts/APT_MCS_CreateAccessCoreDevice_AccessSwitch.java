...
public class APT_MCS_CreateAccessCoreDevice_AccessSwitch extends DriverTestcase {
	...
	public void createAccessCoreDevice_AccessSwitch(Map<String, String> map) throws Exception {
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyNavigationToCreateAccessCoreDevicePage_Access Switch");
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyAndAddCreateAccessSwitch_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyEnteredValueForCreateAccessSwitch_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("editAccessSwitch_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessagefor_AccessSwitchDevice_"+devicename);
			APT_CreateAccessSwitchDeviceHelper.get().verifyDeviceUpdationSuccessMessage("CreateAccessCoreDevice");
	
			
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessageforAccessSwitch_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("deleteAccessSwitch_"+devicename);
