...
public class APT_MCS_CreateAccessCoreDevice_DCNDevice extends DriverTestcase {
	...
	public void createAccessCoreDevice_DCNdevice(Map<String, String> map) throws Exception {
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyNavigationToCreateAccessCoreDevicePage_DCN Device");
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyAndAddDCNdevice_"+ devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceCreationMessageforDCNDevice_"+devicename);
			APT_CreateDCNDeviceHelper.get().verifyDeviceCreationMessage("CreateAccessCoreDevice");
	
			
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyEnteredValueForDCNDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("editDCNdevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationMessageforDCNDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("deleteDCNdevice_"+devicename);
