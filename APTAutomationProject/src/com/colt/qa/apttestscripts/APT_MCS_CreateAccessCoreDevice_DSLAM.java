...
public class APT_MCS_CreateAccessCoreDevice_DSLAM extends DriverTestcase {
	...
	public void CreateAccessCoreDevice_DSLAM(Map<String, String> map) throws Exception {
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyNavigationToCreateDevicePage_DSLAM");
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("createDSLAMdevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceCreationMessageforDSLAMdevice_"+devicename);
			APT_CreateDSLAMDeviceHelper.get().verifyDeviceCreationMessage("CreateAccessCoreDevice");

			
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyEnteredValueForDSLAMDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("editDSLAMDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessageforDSLAMDevice_"+devicename);
			APT_CreateDSLAMDeviceHelper.get().verifyDeviceUpdationSuccessMessage("CreateAccessCoreDevice");
	
			
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyUpdatedValueForDSLAMDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("deleteDSLAMdevice");
