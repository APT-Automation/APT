...
public class APT_MCS_CreateAccessCoreDevice_LoadBalancer extends DriverTestcase {
	...
	public void verifyCreateAccessCoreDevice_LoadBalancer(Map<String, String> map) throws Exception {
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyNavigationToCreateDevicePage_LoadBalancer");
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("createLoadBalancerdevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceCreationMessagefor_LoadBalancerDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("editLoadBalancerDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessagefor_LoadBalancerevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("deleteLoadBalancerDevice_"+devicename);
