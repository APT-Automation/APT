...
public class APT_MCS_CreateAccessCoreDevice_LoadBalancer extends DriverTestcase {
	...
	@Test(description = "TC-01",dataProviderClass = DataReader.class, dataProvider = "DataReader_LoadBalancer_Device", priority=0)
	public void verifyCreateAccessCoreDevice_LoadBalancer(Map<String, String> map) throws Exception {
		...
		logger= ExtentTestManager.startTest ("createLoadBalancerdevice_"+devicename);
		...
		logger= ExtentTestManager.startTest ("editLoadBalancerDevice_"+devicename);
		...
		logger= ExtentTestManager.startTest ("deleteLoadBalancerDevice_"+devicename);
