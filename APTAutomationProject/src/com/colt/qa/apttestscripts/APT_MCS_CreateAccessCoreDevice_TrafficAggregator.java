...
public class APT_MCS_CreateAccessCoreDevice_TrafficAggregator extends DriverTestcase {
	...
	public void createAccessCoreDevice_TrafficAggregator(Map<String, String> map) throws Exception {
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyNavigationToCreateAccessCoreDevicePage_Traffic Aggregator");
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("createTrafficAggregatorDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceCreationMessagefor_TrafficAggregatorDevice_"+devicename);
			APT_CreateTrafficAggregatorDeviceHelper.get().verifyDeviceCreationMessage("CreateAccessCoreDevice");
	
			
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyEnteredValueForTrafficAggregatorDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("editTrafficAggregatorDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessagefor_TrafficAggregatorDevice_"+devicename);
			APT_CreateTrafficAggregatorDeviceHelper.get().verifyDeviceUpdationSuccessMessage("CreateAccessCoreDevice");
	
			
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyUpdatedValueForTrafficAggregatorDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("deleteTrafficAggregatorDevice_"+devicename);
