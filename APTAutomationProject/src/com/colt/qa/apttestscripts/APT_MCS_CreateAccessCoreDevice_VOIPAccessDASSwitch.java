...
public class APT_MCS_CreateAccessCoreDevice_VOIPAccessDASSwitch extends DriverTestcase {
	...
	public void createAccessCoreDevice_VOIPAccessDASSwitch(Map<String, String> map) throws Exception {
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyNavigationToCreateAccessCoreDevicePage_VOIPAccessDASSwitch");
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("createVOIPaccessDASswitchDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceCreationMessageforVOIPaccessDASswitchDevice_"+devicename);
			APT_CreateVOIPAccessDASSwitchDeviceHelper.get().verifyDeviceCreationMessage("CreateAccessCoreDevice");
	
			
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyEnteredValueForVOIPaccessDASswitchDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("editVOIPaccessDASswitchDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessagefor_VOIPaccessDASswitchDevice_"+devicename);
			APT_CreateVOIPAccessDASSwitchDeviceHelper.get().verifyDeviceUpdationSuccessMessage("CreateAccessCoreDevice");
	
			
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyEnteredValueForVOIPaccessDASswicthDevice_"+devicename);
		...
		DriverTestcase.logger = DriverTestcase.extent.startTest("deleteVOIPaccessDASswitchdevice_"+devicename);
