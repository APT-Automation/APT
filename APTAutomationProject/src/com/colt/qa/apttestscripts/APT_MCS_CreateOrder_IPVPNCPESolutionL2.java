 ...
 *
 */
public class APT_MCS_CreateOrder_IPVPNCPESolutionL2 extends DriverTestcase{
	APT_Login Login=new APT_Login();
	
	
	@Test(description = "TC-01",dataProviderClass = DataReader.class, dataProvider = "Finaldatareader_IPVPNCPESolutionL2", priority=0)
	public void CPESolutionL2(Map<String, String> map) throws Exception {
		setup();
		Login.APT_Login_1(map.get("url for the Product"));
		
		if(map.get("New Customer").equalsIgnoreCase("Yes")) {
		logger= ExtentTestManager.startTest("CreateCustomer-CPEL2"); 
		...
		logger= ExtentTestManager.startTest("selectCustomertocreateOrder-CPEL2");
		...
		ExtentTestManager.endTest();
			...
			logger= ExtentTestManager.startTest("createneworderservice-CPEL2");
			...
			ExtentTestManager.endTest();
			logger= ExtentTestManager.startTest("verifyservicetypeandSubtype-CPEL2");
		 APT_IPVPNHelper.get().verifyservicetypeandSubtype("ipvpnservice", map.get("ServiceType"),map.get("ServiceSubType"));
		 ExtentTestManager.endTest();
		 logger= ExtentTestManager.startTest("createservice-CPEL2");
		 ...
		 logger= ExtentTestManager.startTest("verifyCustomerDetailsInformation-CPEL2");	
		 	APT_IPVPNHelper.get().selectCustomertocreateOrder("ipvpnservice",map.get("ChooseCustomerToBeSelected"),map.get("Name1"),map.get("Name2"));	
		...
		//logger= ExtentTestManager.startTest("verifyUserDetailsInformation-CPEL2");
	 	//APT_IPVPNHelper.get().selectCustomertocreateOrder("ipvpnservice",map.get("ChooseCustomerToBeSelected"),map.get("Name1"),map.get("Name2"));
	...
	//APT_IPVPNHelper.get().Deletenewuser("ipvpnservice", map.get("UserName"));
	 ...
	 logger= ExtentTestManager.startTest("verifyOrderDetailsInformation-CPEL2");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyorderpanel_editorder-CPEL2");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyorderpanel_changeorder-CPEL2");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyServicepanelinviewservicepage-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("Editservice-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("syncservices-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().syncservices("ipvpnservice");
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("Dumpservice-CPEL2");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyAddedVPNSiteInformation-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	/*
	logger= ExtentTestManager.startTest("verifyEditDeviceFunction-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	*/
	logger= ExtentTestManager.startTest("showNewInfovistaReport-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().shownewInfovista("ipvpnservice");
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddNewDevice-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	 logger= ExtentTestManager.startTest("AddWholesaleInterconnect-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("CreateCPEDevice-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("ViewCPEDevice-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditCPEDevice-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditCPEDevice("ipvpnservice", map.get("ServiceSubType"),map.get("CPE_VPN Vendor/Model"),map.get("CPE_Router Id"),map.get("CPE_Management Address"),map.get("VPN Site Order Num"),map.get("CPEGetAddress"),map.get("CPEAvailableBlock"),map.get("CPEPremiseName"),map.get("CPEPremiseCode")
			,map.get("CPEPremiseToggle"),map.get("CPEJitterRadio"),map.get("CPEConnectPortalTal"),map.get("CPEConnectPortalSsh"),map.get("CPEPremiseddn"),map.get("CPESNMP3"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddInterfaceCPE-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditInterfaceCPE-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditInterfaceCPE("ipvpnservice", map.get("ServiceSubType"),map.get("CPEBearerType"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("CPEDeviceConfiguration-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("SelectInterface-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteInterfaceCPE-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	if ((map.get("ServiceSubType").contains("IPVPN"))&& (!map.get("ServiceSubType").equalsIgnoreCase("IPVPN Access"))) {
		logger= ExtentTestManager.startTest("addPPPconfiguration-CPEL2");	
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();		
	logger= ExtentTestManager.startTest("viewPPPconfiguration-CPEL2");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("editPPPconfiguration-CPEL2");
	...
	//logger= ExtentTestManager.startTest("deletePPPconfiguration-CPEL2");
	//APT_IPVPNHelper.get().deletePPPconfiguration("ipvpnservice");
	
	ExtentTestManager.endTest();
	}
	logger= ExtentTestManager.startTest("AddMultilinkCPE-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().AddMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditMultilinkCPE-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteMultilinkCPE-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().DeleteMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddRoutesCPE-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditRoutesCPE-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteRoutesCPE-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddRouterTool-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("DeleteCPEDevice-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("PEdevice-CPEL2"); 
	...
	//verify whether Equipment panel is available	
		...
		ExtentTestManager.endTest();
		logger= ExtentTestManager.startTest("PEdevice_addInterface-CPEL2");
		...
		//Delete Interface
			...
			logger= ExtentTestManager.startTest("CPE to CPE Links-CPEL2"); 
			APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
			...
			logger= ExtentTestManager.startTest("Actelis-CPEL2");	
			APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
    ...
    logger= ExtentTestManager.startTest("DeleteVPNSiterder-CPEL2");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
