 ...
 *
 */
public class APT_MCS_CreateOrder_IPVPNIPVoice extends DriverTestcase{
	APT_Login Login=new APT_Login();
	
	
	@Test(description = "TC-01",dataProviderClass = DataReader.class, dataProvider = "Finaldatareader_IPVPNIPVoice", priority=0)
	public void IPVPN_IPVoice(Map<String, String> map) throws Exception {
		setup();
		Login.APT_Login_1(map.get("url for the Product"));
		
		if(map.get("New Customer").equalsIgnoreCase("Yes")) {
		logger= ExtentTestManager.startTest("CreateCustomer-IPVPNIPVoice"); 
		...
		logger= ExtentTestManager.startTest("selectCustomertocreateOrder-IPVPNIPVoice");
		...
		ExtentTestManager.endTest();
			...
			logger= ExtentTestManager.startTest("createneworderservice-IPVPNIPVoice");
			...
			ExtentTestManager.endTest();
			logger= ExtentTestManager.startTest("verifyservicetypeandSubtype-IPVPNIPVoice");
		 APT_IPVPNHelper.get().verifyservicetypeandSubtype("ipvpnservice", map.get("ServiceType"),map.get("ServiceSubType"));
		 ExtentTestManager.endTest();
		 logger= ExtentTestManager.startTest("createservice-IPVPNIPVoice");
		 ...
		 logger= ExtentTestManager.startTest("verifyCustomerDetailsInformation-IPVPNIPVoice");	
		 	APT_IPVPNHelper.get().selectCustomertocreateOrder("ipvpnservice",map.get("ChooseCustomerToBeSelected"),map.get("Name1"),map.get("Name2"));	
		...
		//logger= ExtentTestManager.startTest("verifyUserDetailsInformation-IPVPNIPVoice");
	 	//APT_IPVPNHelper.get().selectCustomertocreateOrder("ipvpnservice",map.get("ChooseCustomerToBeSelected"),map.get("Name1"),map.get("Name2"));
	...
	//APT_IPVPNHelper.get().Deletenewuser("ipvpnservice", map.get("UserName"));
	 ...
	 logger= ExtentTestManager.startTest("verifyOrderDetailsInformation-IPVPNIPVoice");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyorderpanel_editorder-IPVPNIPVoice");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyorderpanel_changeorder-IPVPNIPVoice");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyServicepanelinviewservicepage-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("Editservice-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("syncservices-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().syncservices("ipvpnservice");
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("Dumpservice-IPVPNIPVoice");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyAddedVPNSiteInformation-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	/*
	logger= ExtentTestManager.startTest("verifyEditDeviceFunction-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	*/
	logger= ExtentTestManager.startTest("showNewInfovistaReport-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().shownewInfovista("ipvpnservice");
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddNewDevice-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	 logger= ExtentTestManager.startTest("AddWholesaleInterconnect-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("CreateCPEDevice-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("ViewCPEDevice-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditCPEDevice-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditCPEDevice("ipvpnservice", map.get("ServiceSubType"),map.get("CPE_VPN Vendor/Model"),map.get("CPE_Router Id"),map.get("CPE_Management Address"),map.get("VPN Site Order Num"),map.get("CPEGetAddress"),map.get("CPEAvailableBlock"),map.get("CPEPremiseName"),map.get("CPEPremiseCode")
			,map.get("CPEPremiseToggle"),map.get("CPEJitterRadio"),map.get("CPEConnectPortalTal"),map.get("CPEConnectPortalSsh"),map.get("CPEPremiseddn"),map.get("CPESNMP3"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddInterfaceCPE-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditInterfaceCPE-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditInterfaceCPE("ipvpnservice", map.get("ServiceSubType"),map.get("CPEBearerType"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("CPEDeviceConfiguration-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("SelectInterface-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteInterfaceCPE-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	if ((map.get("ServiceSubType").contains("IPVPN"))&& (!map.get("ServiceSubType").equalsIgnoreCase("IPVPN Access"))) {
		logger= ExtentTestManager.startTest("addPPPconfiguration-IPVPNIPVoice");	
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();		
	logger= ExtentTestManager.startTest("viewPPPconfiguration-IPVPNIPVoice");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("editPPPconfiguration-IPVPNIPVoice");
	...
	//logger= ExtentTestManager.startTest("deletePPPconfiguration-IPVPNIPVoice");
	//APT_IPVPNHelper.get().deletePPPconfiguration("ipvpnservice");
	
	ExtentTestManager.endTest();
	}
	logger= ExtentTestManager.startTest("AddMultilinkCPE-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().AddMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditMultilinkCPE-IPVPNIPVoice-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteMultilinkCPE-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().DeleteMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddRoutesCPE-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditRoutesCPE-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteRoutesCPE-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddRouterTool-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("DeleteCPEDevice-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	//verify whether Equipment panel is available	
		...
		ExtentTestManager.endTest();
		logger= ExtentTestManager.startTest("PEdevice_addInterface-IPVPNIPVoice");
		...
		//Delete Interface
			...
			logger= ExtentTestManager.startTest("CPE to CPE Links-IPVPNIPVoice"); 
			APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
			...
			logger= ExtentTestManager.startTest("Actelis-IPVPNIPVoice");	
			APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
    ...
    logger= ExtentTestManager.startTest("DeleteVPNSiterder-IPVPNIPVoice");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
