 ...
 *
 */
public class APT_MCS_CreateOrder_IPVPNPlus extends DriverTestcase{
	APT_Login Login=new APT_Login();
	
	
	@Test(description = "TC-01",dataProviderClass = DataReader.class, dataProvider = "Finaldatareader_IPVPNPlus", priority=0)
	public void IPVPN_Plus(Map<String, String> map) throws Exception {
		setup();
		Login.APT_Login_1(map.get("url for the Product"));
		
		if(map.get("New Customer").equalsIgnoreCase("Yes")) {	
		logger= ExtentTestManager.startTest("CreateCustomer-IPVPNPlus"); 
		...
		logger= ExtentTestManager.startTest("selectCustomertocreateOrder-IPVPNPlus");
		...
		ExtentTestManager.endTest();
			...
			logger= ExtentTestManager.startTest("createneworderservice-IPVPNPlus");
			...
			ExtentTestManager.endTest();
			logger= ExtentTestManager.startTest("verifyservicetypeandSubtype-IPVPNPlus");
		 APT_IPVPNHelper.get().verifyservicetypeandSubtype("ipvpnservice", map.get("ServiceType"),map.get("ServiceSubType"));
		 ExtentTestManager.endTest();
		 logger= ExtentTestManager.startTest("createservice-IPVPNPlus");
		 ...
		 logger= ExtentTestManager.startTest("verifyCustomerDetailsInformation-IPVPNPlus");	
		 	APT_IPVPNHelper.get().selectCustomertocreateOrder("ipvpnservice",map.get("ChooseCustomerToBeSelected"),map.get("Name1"),map.get("Name2"));	
		...
		//logger= ExtentTestManager.startTest("verifyUserDetailsInformation-IPVPNPlus");
	 	//APT_IPVPNHelper.get().selectCustomertocreateOrder("ipvpnservice",map.get("ChooseCustomerToBeSelected"),map.get("Name1"),map.get("Name2"));
	...
	//APT_IPVPNHelper.get().Deletenewuser("ipvpnservice", map.get("UserName"));
	 ...
	 logger= ExtentTestManager.startTest("verifyOrderDetailsInformation-IPVPNPlus");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyorderpanel_editorder-IPVPNPlus");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyorderpanel_changeorder-IPVPNPlus");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyServicepanelinviewservicepage-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("Editservice-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("syncservices-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().syncservices("ipvpnservice");
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("Dumpservice-IPVPNPlus");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyAddedVPNSiteInformation-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("verifyEditDeviceFunction-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("showNewInfovistaReport-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().shownewInfovista("ipvpnservice");
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddNewDevice-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	 logger= ExtentTestManager.startTest("AddWholesaleInterconnect-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("CreateCPEDevice-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("ViewCPEDevice-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditCPEDevice-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditCPEDevice("ipvpnservice", map.get("ServiceSubType"),map.get("CPE_VPN Vendor/Model"),map.get("CPE_Router Id"),map.get("CPE_Management Address"),map.get("VPN Site Order Num"),map.get("CPEGetAddress"),map.get("CPEAvailableBlock"),map.get("CPEPremiseName"),map.get("CPEPremiseCode")
			,map.get("CPEPremiseToggle"),map.get("CPEJitterRadio"),map.get("CPEConnectPortalTal"),map.get("CPEConnectPortalSsh"),map.get("CPEPremiseddn"),map.get("CPESNMP3"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddInterfaceCPE-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditInterfaceCPE-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("SelectInterface-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteInterfaceCPE-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	if ((map.get("ServiceSubType").contains("IPVPN"))&& (!map.get("ServiceSubType").equalsIgnoreCase("IPVPN Access"))) {
		logger= ExtentTestManager.startTest("addPPPconfiguration-IPVPNPlus");	
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();		
	logger= ExtentTestManager.startTest("viewPPPconfiguration-IPVPNPlus");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("editPPPconfiguration-IPVPNPlus");
	...
	logger= ExtentTestManager.startTest("AddMultilinkCPE-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().AddMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditMultilinkCPE-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteMultilinkCPE-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().DeleteMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddRoutesCPE-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditRoutesCPE-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteRoutesCPE-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddRouterTool-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("DeleteCPEDevice-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	boolean EquipmentPanel=APT_IPVPNHelper.get().findPanelHeader("ipvpnservice", "Provider Equipment (PE)",map.get("VPN Site Order Num"));
		...
		ExtentTestManager.endTest();
		logger= ExtentTestManager.startTest("PEdevice_addInterface-IPVPNPlus");
		...
		//Delete Interface
			...
			logger= ExtentTestManager.startTest("CPE to CPE Links-IPVPNPlus"); 
			APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
			...
			logger= ExtentTestManager.startTest("Actelis-IPVPNPlus");	
			APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
    ...
    logger= ExtentTestManager.startTest("DeleteVPNSiterder-IPVPNPlus");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
