 ...
 *
 */
public class APT_MCS_CreateOrder_IPVPNSwiftNet extends DriverTestcase{
	APT_Login Login=new APT_Login();
	
	
	@Test(description = "TC-01",dataProviderClass = DataReader.class, dataProvider = "Finaldatareader_IPVPNSwiftNet", priority=0)
	public void IPVPN_SwiftNet(Map<String, String> map) throws Exception {
		setup();
		Login.APT_Login_1(map.get("url for the Product"));
		
		if(map.get("New Customer").equalsIgnoreCase("Yes")) {
		logger= ExtentTestManager.startTest("CreateCustomer-SwiftNet"); 
		...
		logger= ExtentTestManager.startTest("selectCustomertocreateOrder-SwiftNet");
		...
		ExtentTestManager.endTest();
			...
			logger= ExtentTestManager.startTest("createneworderservice-SwiftNet");
			...
			ExtentTestManager.endTest();
			logger= ExtentTestManager.startTest("verifyservicetypeandSubtype-SwiftNet");
		 APT_IPVPNHelper.get().verifyservicetypeandSubtype("ipvpnservice", map.get("ServiceType"),map.get("ServiceSubType"));
		 ExtentTestManager.endTest();
		 logger= ExtentTestManager.startTest("createservice-SwiftNet");
		 ...
		 logger= ExtentTestManager.startTest("verifyCustomerDetailsInformation-SwiftNet");	
		 	APT_IPVPNHelper.get().selectCustomertocreateOrder("ipvpnservice",map.get("ChooseCustomerToBeSelected"),map.get("Name1"),map.get("Name2"));	
	...
	//APT_IPVPNHelper.get().Deletenewuser("ipvpnservice", map.get("UserName"));
	 ...
	 logger= ExtentTestManager.startTest("verifyOrderDetailsInformation-SwiftNet");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyorderpanel_editorder-SwiftNet");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyorderpanel_changeorder-SwiftNet");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyServicepanelinviewservicepage-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("Editservice-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("syncservices-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().syncservices("ipvpnservice");
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("Dumpservice-SwiftNet");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("verifyAddedVPNSiteInformation-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
/*
	logger= ExtentTestManager.startTest("verifyEditDeviceFunction-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	*/
	logger= ExtentTestManager.startTest("showNewInfovistaReport-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().shownewInfovista("ipvpnservice");
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddNewDevice-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	 logger= ExtentTestManager.startTest("AddWholesaleInterconnect-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("CreateCPEDevice-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("ViewCPEDevice-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditCPEDevice-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditCPEDevice("ipvpnservice", map.get("ServiceSubType"),map.get("CPE_VPN Vendor/Model"),map.get("CPE_Router Id"),map.get("CPE_Management Address"),map.get("VPN Site Order Num"),map.get("CPEGetAddress"),map.get("CPEAvailableBlock"),map.get("CPEPremiseName"),map.get("CPEPremiseCode")
			,map.get("CPEPremiseToggle"),map.get("CPEJitterRadio"),map.get("CPEConnectPortalTal"),map.get("CPEConnectPortalSsh"),map.get("CPEPremiseddn"),map.get("CPESNMP3"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddInterfaceCPE-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditInterfaceCPE-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditInterfaceCPE("ipvpnservice", map.get("ServiceSubType"),map.get("CPEBearerType"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("CPEDeviceConfiguration-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("SelectInterface-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteInterfaceCPE-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	if ((map.get("ServiceSubType").contains("IPVPN"))&& (!map.get("ServiceSubType").equalsIgnoreCase("IPVPN Access"))) {
		logger= ExtentTestManager.startTest("addPPPconfiguration-SwiftNet");	
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();		
	logger= ExtentTestManager.startTest("viewPPPconfiguration-SwiftNet");
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("editPPPconfiguration-SwiftNet");
	...
	//logger= ExtentTestManager.startTest("deletePPPconfiguration-SwiftNet");
	//APT_IPVPNHelper.get().deletePPPconfiguration("ipvpnservice");
	
	ExtentTestManager.endTest();
	}
	logger= ExtentTestManager.startTest("AddMultilinkCPE-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().AddMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditMultilinkCPE-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().EditMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteMultilinkCPE-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	APT_IPVPNHelper.get().DeleteMultilinkCPE("ipvpnservice", map.get("ServiceSubType"),map.get("MultilinkEthernetCheckbox"),map.get("CPEBandwidthE1"),map.get("CPEBandwidthE3"),map.get("CPEBandwidthSTM"),map.get("CPELink"),map.get("CpeEncapsulation"),map.get("CpeClockSource"),map.get("CpePrimary/Backup")
			...
			map.get("InterfaceGetAddress"),map.get("CPE_Router Id"),map.get("VPN Site Order Num"),map.get("CpeAddInterfaceButton"),map.get("InterfaceCNGReferance"));
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddRoutesCPE-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("EditRoutesCPE-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("DeleteRoutesCPE-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	ExtentTestManager.endTest();
	logger= ExtentTestManager.startTest("AddRouterTool-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("DeleteCPEDevice-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
	...
	logger= ExtentTestManager.startTest("PEdevice-SwiftNet"); 
	...
	//verify whether Equipment panel is available	
		...
		ExtentTestManager.endTest();
		logger= ExtentTestManager.startTest("PEdevice_addInterface-SwiftNet");
		...
		//Delete Interface
			...
			logger= ExtentTestManager.startTest("CPE to CPE Links-SwiftNet"); 
			APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
			...
			logger= ExtentTestManager.startTest("Actelis-SwiftNet");	
			APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
    ...
    logger= ExtentTestManager.startTest("DeleteVPNSiterder-SwiftNet");
	APT_IPVPNHelper.get().searchorder("ipvpnservice", map.get("ServiceIdentification"));
