...
APT_Login Login=new APT_Login();
	...
	public void VOIPAccessTestCases(Map<String, String> map) throws Exception {
        ...
        logger= ExtentTestManager.startTest ("verifyNewOrderCreationOrExistingOrderSelection");
...
//		logger= ExtentTestManager.startTest ("VerifyEditOrderChangeOrderFunction");
//		APT_VOIPHelper.get().searchorder("voipservice", map.get("ServiceIdentification"));
...
//		//extent.flush();
		...
		logger= ExtentTestManager.startTest ("VerifyServiceInfoEditSeviceFunction");
		APT_VOIPHelper.get().searchorder("voipservice", map.get("ServiceIdentification"));
		...
		logger= ExtentTestManager.startTest ("verifyManageService_ManageSubnet_IPv6");
		APT_VOIPHelper.get().searchorder("voipservice", map.get("ServiceIdentification"));
		...
		logger= ExtentTestManager.startTest ("verifyDumpFunction");
		APT_VOIPHelper.get().searchorder("voipservice", map.get("ServiceIdentification"));
...
//		
		...
		logger= ExtentTestManager.startTest ("verifyAddMASswitchFunction");
		...
		logger= ExtentTestManager.startTest ("verifyAddedMASswitchInformation");
		//**APT_VOIPHelper.get().searchorder("voipservice", map.get("MAS_ServiceIdentification"));
		...
		logger= ExtentTestManager.startTest ("verifyEditMasSwitchFunction");
		//**APT_VOIPHelper.get().searchorder("voipservice", map.get("MAS_ServiceIdentification"));
		//**APT_VOIPHelper.get().navigateToViewDevicePage_MAS("voipservice", map.get("MAS_DeviceName"));
		...
		logger= ExtentTestManager.startTest ("verifyFetchDeviceInterfaceFunction_MAS");
		//**APT_VOIPHelper.get().searchorder("voipservice", map.get("MAS_ServiceIdentification"));
		//**APT_VOIPHelper.get().navigateToViewDevicePage_MAS("voipservice", map.get("MAS_DeviceName"));
		...
		logger= ExtentTestManager.startTest ("verifyRouterToolFunction_MAS");
		//**APT_VOIPHelper.get().searchorder("voipservice", map.get("MAS_ServiceIdentification"));
		...
		APT_VOIPHelper.get().routerPanel_MAS("voipservice", map.get("MAS_CommandIPV4"), map.get("MAS_CommandIPV6"),
			...
			logger= ExtentTestManager.startTest ("verifyAddInterfaceFunction_MAS");
			//**APT_VOIPHelper.get().searchorder("voipservice", map.get("MAS_ServiceIdentification"));
			//APT_VOIPHelper.get().navigateToViewDevicePage_MAS("voipservice", map.get("MAS_DeviceName"));
			//**APT_VOIPHelper.get().navigateToDevicePageFromManageColtNetwork_MAS("voipservice", "MAS_DeviceName");
			...
			logger= ExtentTestManager.startTest ("verifyEditInterfaceFunction_MAS");
			APT_VOIPHelper.get().searchorder("voipservice", map.get("MAS_ServiceIdentification"));
			//**APT_VOIPHelper.get().verifyAddMASswitch("voipservice", map.get("MAS_IMSPOPLocation"));
			...
			logger= ExtentTestManager.startTest ("verifyConfigureInterfaceFunction_MAS");
			APT_VOIPHelper.get().searchorder("voipservice", map.get("MAS_ServiceIdentification"));
			...
			logger= ExtentTestManager.startTest ("verifyDeleteInterfaceFunction_MAS");
				APT_VOIPHelper.get().searchorder("voipservice", map.get("MAS_ServiceIdentification"));
				//**APT_VOIPHelper.get().verifyAddMASswitch("voipservice", map.get("MAS_IMSPOPLocation"));
			...
			logger= ExtentTestManager.startTest ("verifyDeleteDeviceFunction_MAS");
		...
		*/
		...
		logger= ExtentTestManager.startTest ("verifyAddPEDeviceFunction");
		...
		logger= ExtentTestManager.startTest ("verifyAddedPEDeviceInformation");
		//**APT_VOIPHelper.get().searchorder("voipservice", map.get("PE_ServiceIdentification"));
		...
		logger= ExtentTestManager.startTest ("verifyEditPEDeviceFunction");
		//**APT_VOIPHelper.get().searchorder("voipservice", map.get("PE_ServiceIdentification"));
		//*APT_VOIPHelper.get().navigateToViewDevicePage_PE("voipservice", "PE_DeviceName");
		...
		logger= ExtentTestManager.startTest ("verifyFetchDeviceInterfaceFunction_PE");
		//**APT_VOIPHelper.get().searchorder("voipservice", map.get("PE_ServiceIdentification"));
		//**APT_VOIPHelper.get().navigateToViewDevicePage_PE("voipservice", "PE_DeviceName");
		...
		logger= ExtentTestManager.startTest ("verifyRouterToolFunction_PE");
		APT_VOIPHelper.get().searchorder("voipservice", map.get("PE_ServiceIdentification"));
		APT_VOIPHelper.get().navigateToViewDevicePage_PE("voipservice", "PE_DeviceName");
		...
		logger= ExtentTestManager.startTest ("verifyAddInterfaceFunction_PE");
		//**APT_VOIPHelper.get().searchorder("voipservice", map.get("PE_ServiceIdentification"));
		//**APT_VOIPHelper.get().navigateToViewDevicePage_PE("voipservice", "PE_DeviceName");
		APT_VOIPHelper.get().verifyAddInterfaceFunction_PE("voipservice",map.get("PE_AccessMedia"),map.get("PE_Network"),map.get("PE_VRRPBGP"),
			...
			logger= ExtentTestManager.startTest ("verifyEditInterfaceFunction_PE");
			APT_VOIPHelper.get().searchorder("voipservice", map.get("PE_ServiceIdentification"));
			...
			logger= ExtentTestManager.startTest ("verifyConfigureInterfaceFunction_PE");
			APT_VOIPHelper.get().searchorder("voipservice", map.get("PE_ServiceIdentification"));
			//**APT_VOIPHelper.get().verifyAddPEDevice("voipservice", map.get("PE_IMSPOPLocation"));
			...
			logger= ExtentTestManager.startTest ("verifyDeleteInterfaceFunction_PE");
			APT_VOIPHelper.get().searchorder("voipservice", map.get("PE_ServiceIdentification"));
			//**APT_VOIPHelper.get().verifyAddPEDevice("voipservice", map.get("PE_IMSPOPLocation"));
			...
			logger= ExtentTestManager.startTest ("verifyDeleteDeviceFunction_PE");
			APT_VOIPHelper.get().searchorder("voipservice", map.get("PE_ServiceIdentification"));
		...
		*/
			...
			logger= ExtentTestManager.startTest ("verifyTrunkGroupSiteOrderFunction");
			...
			System.out.println("TC-33");
			 logger= ExtentTestManager.startTest ("verifyAddTrunkFunction");
			//*APT_VOIPHelper.get().searchorder("voipservice", map.get("ServiceIdentification"));
			//*APT_VOIPHelper.get().addTrunkGroupSiteOrderNumber("voipservice", map.get("TrunkGroupOrderCheckboxStatus"), map.get("TrunkGroupSiteOrderNumber"));
			APT_VOIPHelper.get().verifyAddedSiteOrderAndTrunkLinkUnderTrunkPanel("voipservice", map.get("TrunkGroupSiteOrderNumber"));
			...
			logger= ExtentTestManager.startTest ("verifyAddedTrunkInformationInviewTrunk");
...
//			logger= ExtentTestManager.startTest ("editTrunk");
//			APT_VOIPHelper.get().searchorder("voipservice", map.get("Trunk_ServiceIdentification"));
//			APT_VOIPHelper.get().navigateToViewTrunkPage("voipservice", map.get("TrunkGroupSiteOrderNumber"), map.get("ExistingTrunkName"));
...
//					map.get("editCreateLowerCaseRoutervalue"), map.get("edit_PSXmanualConfigvalue"), map.get("edit_GSXmanualConfigvalue"));
			...
			logger= ExtentTestManager.startTest ("viewTrunk_History");
			...
			logger= ExtentTestManager.startTest ("viewTrunk_PSXQueue");
			//**APT_VOIPHelper.get().clickOnViewLink("voipservice", "trunkGroupName", "siteOrderName");
			//**APT_VOIPHelper.get().clickOnBreadCrump("voipservice", map.get("Trunk_ServiceIdentification"));
			APT_VOIPHelper.get().searchorder("voipservice", map.get("Trunk_ServiceIdentification"));
			APT_VOIPHelper.get().navigateToViewTrunkPage("voipservice", map.get("TrunkGroupSiteOrderNumber"), map.get("ExistingTrunkName"));
			...
			logger= ExtentTestManager.startTest ("viewTrunk_GSX_PSX_SBC_configuration");
			...
			logger= ExtentTestManager.startTest ("SBCManuallyExecutedConfigurations");
			...
			logger= ExtentTestManager.startTest ("PSXManuallyExecutedConfigurations");
			...
			logger= ExtentTestManager.startTest ("GSXManuallyExecutedConfigurations");
		...
		logger= ExtentTestManager.startTest ("verifyTrunkAndTrunkSiteOrderDeletion");
		...
		*/
		 ...
		 */
			...
			logger= ExtentTestManager.startTest ("verifyAddCPEDeviceFunction");
			Thread.sleep(2000);
			APT_VOIPHelper.get().searchorder("voipservice", map.get("Trunk_ServiceIdentification"));
		...
		logger= ExtentTestManager.startTest ("verifyAddedCPEDeviceInformation");
		APT_VOIPHelper.get().searchorder("voipservice", map.get("Trunk_ServiceIdentification"));
		...
		logger= ExtentTestManager.startTest ("verifyEditCPEDeviceFunction");
		//**APT_VOIPHelper.get().searchorder("voipservice", map.get("Trunk_ServiceIdentification"));
		...
		logger= ExtentTestManager.startTest ("verifyFetchDeviceInterfaceFunction_CPE");
		//APT_VOIPHelper.get().searchorder("voipservice", map.get("Trunk_ServiceIdentification"));
		...
		logger= ExtentTestManager.startTest ("verifyRouterToolFunction_CPE");
		...
		logger= ExtentTestManager.startTest ("verifyDeleteDeviceFunction_CPE");
