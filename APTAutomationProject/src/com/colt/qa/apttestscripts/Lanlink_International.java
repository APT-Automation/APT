...
public class Lanlink_International extends DriverTestcase{
	...
	public void LANLINK_International(Map<String, String> map) throws Exception {
		...
		Login.APT_Login_1(map.get("url for the Product"));	
			...
			logger= ExtentTestManager.startTest ("verifyListofFieldsForOrderandServicetype_LanlinkInternational");
			...
			logger= ExtentTestManager.startTest ("selectTheServiceType_LanlinkInternational");
			...
			logger= ExtentTestManager.startTest ("verifyFields_LanlinkInternational");
			...
			logger= ExtentTestManager.startTest ("enterData_LanlnkInternational");
...
//							map.get("SiteOrders_ToBeHidden"), map.get("editIPGuardianAccountGroup"), map.get("editColtOnlineUser"));
			...
			logger= ExtentTestManager.startTest ("verifyOrderDetailsInformation_LanlinkInternational");
			...
			logger= ExtentTestManager.startTest ("verifydEnteredValues_LanlinkInternational");
			...
			logger= ExtentTestManager.startTest ("editServiceSubtype_LanlinInternational");
			...
			logger= ExtentTestManager.startTest ("successmessageforServiceUpdation_LanlinkInternational");
			...
			logger= ExtentTestManager.startTest ("synchronizeService_LanlinkInternational");
					International.get().syncservices("LANLINK");
					ExtentTestManager.endTest();
					
			logger= ExtentTestManager.startTest ("showNewInfovistaReport_LanlinkInternational");
					International.get().shownewInfovista("LANLINK");
					ExtentTestManager.endTest();
					
			logger= ExtentTestManager.startTest ("ManageSubnets_LanlinkInternational");
					International.get().manageSubnets("LANLINK");
					ExtentTestManager.endTest();
		
			logger= ExtentTestManager.startTest ("Dump_LanlinkInternational");
			 ...
			 * Site Order		
			 */
			logger= ExtentTestManager.startTest ("verifyAddSiteOrderFields_LanlinkInternational");
			...
			if((vpnTopology.equals("Point-to-Point")) &&  (circuitType.equals("Composite Circuit"))){
				...
				ExtentTestManager.getTest().log(LogStatus.INFO, "Verifying 'Add Site Order' fields");
					...
					logger= ExtentTestManager.startTest ("AddSiteOrder_LANLINKInternational");	
				...
				logger= ExtentTestManager.startTest ("Successmessage_siteOrderCreation_LanlinkInternational");
						International.get().verifysuccessmessage("LANLINK", "Site order created successfully");
						ExtentTestManager.endTest();
					 	
				logger= ExtentTestManager.startTest ("verifyEnteredValues_ForSiteOrder_LanlinkInternational");
				...
				logger= ExtentTestManager.startTest ("editSiteOrder_LanlinkInternational");
		...
		if(((vpnTopology.equals("Point-to-Point")) && (circuitType.equals("Composite Circuit")))  ||  ((vpnTopology.equals("Point-to-Point")) &&  (circuitType.equals("Extended Circuit"))  &&  (sitePreferenceType.equalsIgnoreCase("Circuit")))){
				...
				if(map.get("Interfacespeed").equals("1GigE")) {
					...
					//Overture
						logger = ExtentTestManager.startTest("CircuitCreationFor1G_Overture_LanlinkInternational");
					...
					//Accedian-1G
						logger = ExtentTestManager.startTest("CircuitCreationFor1G_Accedian-1G_LanlinkInternational");
					...
					//Atrica
						logger = ExtentTestManager.startTest("CircuitCreationFor1G_Atrica_LanlinkInternational");
						...
						logger = ExtentTestManager.startTest("createCircuitFor10G_LanlinkInternational");
						//Overture	
						International.get().addOvertureCircuit("LANLINK", map.get("addOverture_serviceNameForCreatingCircuit"));
						International.get().selectInterfaceForCircuits("LANLINK", map.get("addOverture_interfaceName1"), map.get("addOverture_interfaceName2"),
								map.get("addOverture_edgePointSelectForInterface1"), map.get("addOverture_edgePointSelectForInterface2"));
			...
			logger= ExtentTestManager.startTest ("Actelis_Equipment Configuration_LanlinkInternational");
				...
				//Actelis Configuration panel	
					logger= ExtentTestManager.startTest ("Actelis Configuration Panel_Add DSLAM and HSL_LanlinkInternational");
			...
			logger= ExtentTestManager.startTest ("AdddeviceforEquipment_LanlinkInternational");
					...
					if(ModularMSp.equalsIgnoreCase("Yes")) 
					{
						if(existingDevice.equalsIgnoreCase("Yes") && newDevice.equalsIgnoreCase("No")) {
							...
							logger= ExtentTestManager.startTest ("editExistingDevice_MSPselected_Equipment_LanlinkInternational");
							...
							logger= ExtentTestManager.startTest ("verifyEnteredValues_MSPselected_Eqiupment_LanlinkInternational");
							...
							logger= ExtentTestManager.startTest ("editDevice_MSPselected_Equipment_LanlinkInternational");
							International.get().eDITCPEdevicedetailsentered_MSPselected( "LANLINK",  map.get("EDIT_cpename"), map.get("EDIT_cpe_vender_MSPselected"),  map.get("cpe_snmpro"),  map.get("EDIT_cpe_managementAddress"), map.get("EDIT_cpe_Mepid"),
									 map.get("EDIT_cpe_vender_MSPselected_VLANid") );
							International.get().verifysuccessmessage("LANLINK", "Device successfully updated");
							ExtentTestManager.endTest();
					...
					else
					{
						if(speed.equals("1GigE")) {
							if(existingDevice.equalsIgnoreCase("Yes") && newDevice.equalsIgnoreCase("No")) {
								...
								logger= ExtentTestManager.startTest ("editExistingDevice_1G_Equipment_LanlinkInternational");
								...
								logger= ExtentTestManager.startTest ("verifyEnteredValuesforNewDevice_1G_Equipment_LanlinkInternational");
								...
								logger= ExtentTestManager.startTest ("editNewDevice_1G_Equipment_LanlinkInternational");
								International.get().eDITCPEdevicedetailsentered_1G( "LANLINK",  map.get("EDIT_cpename"), map.get("EDIT_cpe_vender_1G"),  map.get("cpe_snmpro"),  map.get("EDIT_cpe_managementAddress"), map.get("EDIT_cpe_Mepid"),
										 map.get("EDIT_cpe_poweralarm_1G"), map.get("EDIT_cpe_Mediaselection"),  map.get("EDIT_cpe_Macaddress"),  map.get("EDIT_cpe_serialNumber"),
										 map.get("EDIT_cpe_hexaSerialnumber"),  map.get("EDIT_cpe_linkLostForwarding"), map.get("devicenameforEquipment"), map.get("technology"));
								International.get().verifysuccessmessage("LANLINK", "Device successfully updated");
						...
						if(speed.equals("10GigE")) {
							if(existingDevice.equalsIgnoreCase("Yes") && newDevice.equalsIgnoreCase("No")) {
								...
								logger= ExtentTestManager.startTest ("editExistingDevice_10G_Equipment_LanlinkInternational");
								...
								logger= ExtentTestManager.startTest ("verifyEnteredValues_10G_Equipment_LanlinkInternational");
								...
								logger= ExtentTestManager.startTest ("editDevice_10G_Equipment_LanlinkInternational");
								International.get().eDITCPEdevicedetailsentered_10G( "LANLINK",  map.get("EDIT_cpename"), map.get("EDIT_cpe_vender_10G"),  map.get("EDIT_cpe_snmpro"),  map.get("EDIT_cpe_managementAddress"), map.get("EDIT_cpe_Mepid"),
										 map.get("EDIT_cpe_poweralarm_10G"), map.get("EDIT_cpe_Mediaselection"),  map.get("EDIT_cpe_Macaddress"),  map.get("EDIT_cpe_serialNumber"),
										 map.get("EDIT_cpe_hexaSerialnumber"),  map.get("EDIT_cpe_linkLostForwarding"), map.get("devicenameforEquipment"));
								International.get().verifysuccessmessage("LANLINK", "Device successfully updated");
						...
						logger = ExtentTestManager.startTest("fetchdeviceInterface_LanlinkInternational");
						...
						logger= ExtentTestManager.startTest ("routerTools_Equipment_LanlinkInternational");
							OLO.get().routerPanel("LANLINK", map.get("CommandIPv4_Routertool"), manageAdres);
							ExtentTestManager.endTest();
						
							
						logger= ExtentTestManager.startTest ("configureEquipment_LanlinkInternational");
							//Site Order Number	
							...
							if(ModularMSp.equalsIgnoreCase("Yes")) {
								...
								String interfaceavailability_configure = DirectFiber.get().EnterdataForEditInterfaceforConfigurelinkunderIntermediateEquipment("LANLINK", 
										map.get("Interfacename_forEditInterface"), map.get("editInterfacepage_circuitId"), map.get("editInterfacepage_BearerType"),
						...
						logger= ExtentTestManager.startTest ("selectInterface_Equipment_LanlinkInternational");
						...
						logger= ExtentTestManager.startTest ("showInterface_Equipment_LanlinkInternational");
							DirectFiber.get().clickOnBreadCrump("LANLINK", siteOrderValue);
							...
							logger= ExtentTestManager.startTest ("AMNvalidator_Equipment_LanlinkInternational");
						...
						logger= ExtentTestManager.startTest ("deleteDevice_Equipment_LanlinkInternational");
							DirectFiber.get().clickOnBreadCrump("LANLINK", siteOrderValue);
					...
					logger= ExtentTestManager.startTest ("addDevice_IntermediateEquipment_LanlinkInternational");
					Thread.sleep(3000);
					...
					if(IntermediateEquipmentPanel) {
						...
						{
							if(existingDevice.equalsIgnoreCase("Yes")  && newDevice.equalsIgnoreCase("No")) {
								ExtentTestManager.getTest().log(LogStatus.INFO, "selectExistingDevice_MSPselected_IntEquipment_LanlinkInternational");
								...
								logger= ExtentTestManager.startTest ("editCPEdevice_MSPselected_IntermediateEquipment_LanlinkInternational");
								...
								logger= ExtentTestManager.startTest ("verifyEnteredValues_MSPselected_IntermediateEquipment_LanlinkInternational");
								...
								logger= ExtentTestManager.startTest ("editDevice_MSpselected_IntermediateEquipment_LanlinkInternational");
								International.get().EDITCPEdevicedforIntermediateEquipment_MSPselected("LANLINK", map.get("EDIT_Intequip_cpe_deviecname"),map.get("EDIT_Intequip_device_vender_MSPselected"),
										 map.get("EDIT_Intequip_devic_snmpro"), map.get("EDIT_Intequip_device_managementAddress"), map.get("EDIT_Intequip_device_Mepid"),map.get("EDIT_Intequip_device_country"),
									    map.get("EDIT_Intequip_device_ExistingcitySelection"),map.get("EDIT_Intequip_device_newcitySelection"), map.get("EDIT_Intequip_device_Existingcity"), map.get("EDIT_Intequip_device_newcityName"), map.get("EDIT_Intequip_device_newcityCode")
										,map.get("EDIT_Intequip_device_ExistingSiteSelection"), map.get("EDIT_Intequip_device_newSiteSelection"), map.get("EDIT_Intequip_device_ExistingSite"), map.get("EDIT_Intequip_device_newSiteName"), map.get("EDIT_Intequip_device_newSiteCode"),
						...
						else
						{
							if(speed.equals("1GigE")) {
								if(existingDevice.equalsIgnoreCase("Yes")  && newDevice.equalsIgnoreCase("No")) {
									...
									logger= ExtentTestManager.startTest ("editCPEdevice_1G_IntermediateEquipment_LanlinkInternational");
									...
									ExtentTestManager.endTest();
									  ...
									  International.get().verifyFieldsandAddCPEdevicefortheserviceselected_IntEquip_1G( "LANLINK",  map.get("device_intEquip_name"), map.get("device_intequip_vender_1G_Overture"),
										...
										logger= ExtentTestManager.startTest ("verifyEnteredValues_1G_IntermediateEquipment_LanlinkInternational");
									...
									if(existingDevice.equalsIgnoreCase("Yes")  && newDevice.equalsIgnoreCase("No")) {
										...
										logger= ExtentTestManager.startTest ("editCPEdevice_10G_IntermediateEquipment_LanlinkInternational");
										...
										logger= ExtentTestManager.startTest ("verifyEnteredValues_10G_IntermediateEquipment_LanlinkInternational");
					...
					logger= ExtentTestManager.startTest ("routerTools_intermediateEquipment_LanlinkInternational");
							International.get().routerPanel("LANLINK", map.get("CommandIPv4_Routertool"), manageAdres_intEquip);
							ExtentTestManager.endTest();
							
					logger= ExtentTestManager.startTest ("selectinterface_IntermediateEquipment_LanlinkInternational");
							DirectFiber.get().clickOnBreadCrump("LANLINK", siteOrderValue);
					...
					logger= ExtentTestManager.startTest ("showInterace_IntermediateEquipment_LanlinkInternational");
							DirectFiber.get().clickOnBreadCrump("LANLINK", siteOrderValue);
					...
					logger= ExtentTestManager.startTest ("deletDeviceFromService_IntermediateEquipment_LanlinkInternational");
					...
					logger= ExtentTestManager.startTest ("PAMTest_LanlinkInternational");
							String ServiceID = null;
							if(map.get("Edit_serviceNumber").equalsIgnoreCase("null")) {
								ServiceID=map.get("serviceNumber");
							}else {
					...
					logger= ExtentTestManager.startTest ("deleteSiteOrder_LanlinkInternational");
							DirectFiber.get().selectRowForsiteorder("LANLINK", map.get("Siteordernumber"), map.get("siteOrderNumber_PointToPoint"), 
									map.get("vpnTopology"), map.get("Interfacespeed"), map.get("siteOrderNumber_10G_PointToPoint"));
				...
				logger= ExtentTestManager.startTest ("deleteService_LanlinkInternational");
