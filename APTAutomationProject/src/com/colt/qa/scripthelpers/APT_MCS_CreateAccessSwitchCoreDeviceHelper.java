...
public class APT_MCS_CreateAccessSwitchCoreDeviceHelper extends DriverHelper{

	public APT_MCS_CreateAccessSwitchCoreDeviceHelper(WebDriver dr) {
		super(dr);
...
//			assertEquals(actualmsg, "Device updated successfully");
    ...
    public void verifyisEmpty(String xpath,String fieldname) throws InterruptedException {
    	...
    	if (ele.isEmpty()) {
    		ExtentTestManager.getTest().log(LogStatus.PASS, "selected field is empty " + fieldname);
    		
    	}else {
    		
    		sa.fail();
    		ExtentTestManager.getTest().log(LogStatus.FAIL, "selected field is not empty " + fieldname);
    	}
    ...
    boolean availability=false;	
    	...
    	try {	
			...
			ExtentTestManager.getTest().log(LogStatus.PASS, " " + fieldname + " checkbox is not selected ");
		}
    }
    ...
    public void verifysnmpversion2c(String application, String snmp2c,String fieldname,String SnmPro, String Snmprw, String snmpro2cvalue, String snmprw2cvalue) throws InterruptedException, DocumentException, IOException {
    	...
    	if(snmp2c.equalsIgnoreCase("yes") && SnmPro.equalsIgnoreCase("yes")&& Snmprw.equalsIgnoreCase("yes")) {
    		...
    		Thread.sleep(3000);
    		ExtentTestManager.getTest().log(LogStatus.PASS, "selected field is : " + fieldname);
    		...
    		ExtentTestManager.getTest().log(LogStatus.PASS, "enterted snmpro value is : " + snmprovalue);
    		Thread.sleep(3000);
    		...
    		ExtentTestManager.getTest().log(LogStatus.PASS, "enterted snmpro value is : " + snmprwvalue);
    		Thread.sleep(3000);
    		...
    		if(!(snmprovalue.isEmpty())&&!(snmprwvalue.isEmpty())) {
    			ExtentTestManager.getTest().log(LogStatus.PASS, "snmpro and snmprw fields are not empty");
    			ExtentTestManager.getTest().log(LogStatus.INFO, "snmpro field value displayed is : " + snmprovalue);
    			ExtentTestManager.getTest().log(LogStatus.INFO, "snmprw field value displayed is : " + snmprwvalue);
    		}else {
    			
    			sa.fail("snmpro and snmprw fields are empty, it has to be prefilled");
    			ExtentTestManager.getTest().log(LogStatus.FAIL, "snmpro and snmprw fields are empty, it has to be prefilled");
    		}
    			
    		
    	}else if(snmp2c.equalsIgnoreCase("no")){
    		
    		ExtentTestManager.getTest().log(LogStatus.INFO, " " + fieldname + " field is not selected ");
    	}
    ...
    public void verifysnmpversion3selection(String application,String snmp3 ,String fieldname, String Snmpv3Username,String Snmpv3Authpassword, String Snmpv3Privpassword, String Snmpv3Usernamevalue, String Snmpv3Authpasswordvalue, String Snmpv3Privpasswordvalue) throws InterruptedException, DocumentException, IOException {
         ...
         if(snmp3.equalsIgnoreCase("yes") && Snmpv3Username.equalsIgnoreCase("yes") && Snmpv3Authpassword.equalsIgnoreCase("yes") &&  Snmpv3Privpassword.equalsIgnoreCase("yes")) {
    		...
    		ExtentTestManager.getTest().log(LogStatus.INFO, "enterted Snmpv3Username value is : " + Snmpv3Usernamevalue1);
    		Thread.sleep(3000);
    		...
    		ExtentTestManager.getTest().log(LogStatus.INFO, "enterted snmpv3authpassword value is : " + snmpv3authpasswordvalue1);
    		Thread.sleep(3000);
    		...
    		ExtentTestManager.getTest().log(LogStatus.INFO, "enterted Snmpv3Privpassword value is : " + Snmpv3Privpasswordvalue1);
    		Thread.sleep(3000);
    		...
    		if(!(Snmpv3Usernamevalue2.isEmpty())&&!(Snmpv3Authpasswordvalue2.isEmpty()) && !(Snmpv3Privpasswordvalue2.isEmpty())) {
    			ExtentTestManager.getTest().log(LogStatus.PASS, "Snmpv3Username,Snmpv3Authpassword,Snmpv3Privpassword fields are not empty");
    			ExtentTestManager.getTest().log(LogStatus.INFO, "snmpro field value displayed is : " + Snmpv3Usernamevalue2);
    			ExtentTestManager.getTest().log(LogStatus.INFO, "snmprw field value displayed is : " + Snmpv3Authpasswordvalue2);
    			ExtentTestManager.getTest().log(LogStatus.INFO, "snmprw field value displayed is : " + Snmpv3Privpasswordvalue2);
    		}else {
    			
    			sa.fail("Snmpv3Username,Snmpv3Authpassword,Snmpv3Privpassword fields are empty, it has to be prefilled");
    			ExtentTestManager.getTest().log(LogStatus.FAIL, "Snmpv3Username,Snmpv3Authpassword,Snmpv3Privpassword fields are empty, it has to be prefilled");
    		}
    ...
    public void verifyExistingcitysitepremiseselection(String application,String existingcity, String existingcityvalue, String existingsite, String existingsitevalue, String existingpremise, String existingpremisevalue) throws InterruptedException, IOException, DocumentException {
    	...
    	if(existingcity.equalsIgnoreCase("yes")&& existingsite.equalsIgnoreCase("yes")&& existingpremise.equalsIgnoreCase("Yes")) {
    		...
    		Thread.sleep(3000);
    		ExtentTestManager.getTest().log(LogStatus.PASS, "Selected Existing City Name is : " + existingcityvalue );
    		...
    		Thread.sleep(3000);
    		ExtentTestManager.getTest().log(LogStatus.PASS, "Selected Existing Site Name is : " + existingsitevalue );
    		...
    		Thread.sleep(3000);
    		ExtentTestManager.getTest().log(LogStatus.PASS, "Selected Existing Premise Name is : " + existingpremisevalue );
    		...
    		ExtentTestManager.getTest().log(LogStatus.INFO, "Existing City, Site and Premise Name is not selected ! "  );
    	}
    ...
    public void verifynewcityselection(String application, String newcity, String cityname, String Citycode, String sitename, String sitecode, String premisename, String premisecode) throws InterruptedException, DocumentException, IOException {
    	...
    	if(newcity.equalsIgnoreCase("Yes")) {
    		...
    		ExtentTestManager.getTest().log(LogStatus.INFO, "Add City is not selected ! "  );
    	}
    ...
    public void verifynewsiteselection(String application, String newsite, String sitename, String sitecode, String premisename, String premisecode) throws InterruptedException, DocumentException, IOException {
    	...
    	if(newsite.equalsIgnoreCase("Yes")) {
    		...
    		ExtentTestManager.getTest().log(LogStatus.INFO, "Add Site is not selected ! "  );
    	}
	...
	//Device Type
		...
		if(devicetype.getText().equalsIgnoreCase("Access Switch")) {
	...
	//management Address 
		...
		click_commonMethod(application, "OK", "okbutton", xml);
		Thread.sleep(3000);
		ExtentTestManager.getTest().log(LogStatus.PASS, "Device is edited successfully");	
    ...
    public void verifydeviceDelete_AccessRouter(String application) throws InterruptedException, DocumentException, IOException{
		...
		ActionButton.click();
		ExtentTestManager.getTest().log(LogStatus.PASS, "Action button is clicked : " + ActionButtonClick);
		Thread.sleep(2000);
	 ...
	 public void existingPremise(String application, String dropdown_xpath, String dropdownValue, String selectPremiseToggleButton, String labelname) throws InterruptedException, DocumentException, IOException {
	    ...
	    try {	
	    	...
	    	if(premiseDisplayed) {
				...
				//Premise name
				edittextFields_commonMethod(application, "Premise Name", "premisenameinputfield", editNewPremiseName, xml);
				
			   //Premise Code	
				edittextFields_commonMethod(application, "Premise Code", "premisecodeinputfield", editNewPremiseCode, xml);
	 ...
	 public void existingSite(String application, String dropdown_xpath, String dropdownValue, String selectSiteToggleButton, String labelname) throws InterruptedException, DocumentException, IOException {
	    ...
	    try {	
	    	...
	    	if(cityDisplayed) {
				...
				//Site name
				edittextFields_commonMethod(application, "Site Name", "sitenameinputfield", editNewSiteName, xml);
				
			   //Site Code	
				edittextFields_commonMethod(application, "Site Code", "sitecodeinputfield", editNewSiteCode, xml);
