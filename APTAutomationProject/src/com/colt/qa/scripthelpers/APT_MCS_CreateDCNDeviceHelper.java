...
public class APT_MCS_CreateDCNDeviceHelper extends DriverHelper{

	public APT_MCS_CreateDCNDeviceHelper(WebDriver dr) {
		super(dr);
...
//Device Name
	...
	//Device Type
		...
		if(devicetype.getText().equalsIgnoreCase("DCN Device")) {
