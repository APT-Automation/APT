...
public class APT_MCS_CreateDSLAMDeviceHelper extends DriverHelper{
    ...
    //Verify Mandatory fields
		...
		try {	
			...
			if(alertPopup) {
				DriverTestcase.logger.log(LogStatus.PASS, "An alert popup message dipslays, when 'device name' selected as 'DSLAM device'");
				System.out.println("An alert popup message dipslays, when 'device name' selected as 'DSLAM device'");
				...
				if(expectedMessage.equalsIgnoreCase("alertMessage")) {
					DriverTestcase.logger.log(LogStatus.PASS, "Alert message is displaying as: "+alertMessage);
					System.out.println( "Alert message is displaying as: "+alertMessage);
					...
					DriverTestcase.logger.log(LogStatus.FAIL, "Alert Message is mismatching. It is displaying as: "+alertMessage);
					System.out.println("Alert Message is mismatching. It is displaying as: "+alertMessage);
				...
				DriverTestcase.logger.log(LogStatus.FAIL, "An alert popup message is not dipslaying, when 'device name' selected as 'DSLAM device'");
				System.out.println("An alert popup message is not dipslaying, when 'device name' selected as 'DSLAM device'");
			}
		}catch(Exception e) {
			e.printStackTrace();
			DriverTestcase.logger.log(LogStatus.FAIL, "An alert popup message is not dipslaying, when 'device name' selected as 'DSLAM device'");
	...
	//Fetch Device name
		...
		if(devicename.endsWith("dslam.colt.net")) {
			DriverTestcase.logger.log(LogStatus.PASS, "device name is displaying as: "+devicename);
			System.out.println("device name is displaying as: "+devicename);
			
			deviceName=devicename;
		}else {
			DriverTestcase.logger.log(LogStatus.FAIL, "device name is displaying as: "+devicename);
			System.out.println("device name is displaying as: "+devicename);
...
//			assertEquals(actualmsg, "Device updated successfully");
    ...
    //Device Name
    	...
    	//Device Type
     		...
     		if(devicetype.equalsIgnoreCase("DSLAM Device")) {
