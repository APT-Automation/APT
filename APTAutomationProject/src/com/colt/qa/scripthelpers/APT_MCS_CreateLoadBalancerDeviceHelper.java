...
//			assertEquals(actualmsg, "Device updated successfully");
    ...
    //Device Name
    	...
    	//Device Type
     		...
     		if(devicetype.equalsIgnoreCase("Load Balancer")) {
...
try {	
	...
	if(alertHeader) {
		...
		if(alertMsg.isEmpty()) {
			DriverTestcase.logger.log(LogStatus.FAIL, "No alert message displays inside the poppu, after clicking on 'IQNet' checkbox. It should display as"
