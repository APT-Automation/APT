...
public class APT_MCS_CreateLoadBalancerDeviceHelper extends DriverHelper{

	public APT_MCS_CreateLoadBalancerDeviceHelper(WebDriver dr) {
		super(dr);
...
//			assertEquals(actualmsg, "Device updated successfully");
    ...
    //Device Name
    	...
    	//Device Type
    		...
    		if(devicetype.getText().equalsIgnoreCase("Load Balancer")) {
...
try {	
	...
	if(alertHeader) {
		...
		if(alertMsg.isEmpty()) {
			ExtentTestManager.getTest().log(LogStatus.FAIL, "No alert message displays inside the poppu, after clicking on 'IQNet' checkbox. It should display as"
...
//		
//		compareText_InViewPage(application, "Full IQNET" , "", xml);
//			   
//	   }
