...
public class APT_MCS_CreateMiniDSLAMDeviceHelper extends DriverHelper{

	public APT_MCS_CreateMiniDSLAMDeviceHelper(WebDriver dr) {
		super(dr);
...
//			assertEquals(actualmsg, "Device updated successfully");
	...
	//Device Type
		...
		if(devicetype.getText().equalsIgnoreCase("Mini DSLAM")) {
