...
public class APT_MCS_CreateVOIPAccessDASSwitchDeviceHelper extends DriverHelper{

	public APT_MCS_CreateVOIPAccessDASSwitchDeviceHelper(WebDriver dr) {
		super(dr);
    ...
    //Device Name
    	...
    	//Device Type
    		...
    		WebElement devicetype = sel.getFirstSelectedOption();
     		...
     		if(devicetype.getText().equalsIgnoreCase("VOIPAccess DAS Switch")) {
