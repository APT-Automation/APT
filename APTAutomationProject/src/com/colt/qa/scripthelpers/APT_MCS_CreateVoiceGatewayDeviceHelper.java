...
public class APT_MCS_CreateVoiceGatewayDeviceHelper extends DriverHelper{

	public APT_MCS_CreateVoiceGatewayDeviceHelper(WebDriver dr) {
		super(dr);
    ...
    //Device Name
    	...
    	//Device Type
    		...
    		WebElement devicetype = sel.getFirstSelectedOption();
     		...
     		if(devicetype.getText().equalsIgnoreCase("Voice-Gateway")) {
