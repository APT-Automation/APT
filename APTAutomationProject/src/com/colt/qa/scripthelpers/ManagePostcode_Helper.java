...
public class ManagePostcode_Helper extends DriverHelper{
	...
	public void selectColtnetwork (String application) throws InterruptedException, DocumentException
	{
		...
		waitForpageload();
			...
			System.out.println("Manage Postcode link verified");
			...
			System.out.println("Manage Postcode link clicked");
...
//		}
	...
	public void verifyManagePostcodeinternal (String application, String Countrylist) throws InterruptedException, DocumentException
	{
		...
		else if(Countrylist.equals("Denmark"))
		{
			...
			System.out.println("Clicked on Denmark Manage Postcode");
		...
		else if(Countrylist.equals("France"))
		{
			...
			System.out.println("Clicked on France Manage Postcode");
		...
		else if (Countrylist.equals("Portugal"))
		{
			...
			System.out.println("Clicked on Portugal Manage  Postcode");
		...
		else if (Countrylist.equals("Spain"))
		{
			...
			System.out.println("Clicked on Spain Manage  Postcode");
		...
		else if (Countrylist.equals("Sweden"))
		{
			...
			System.out.println("Clicked on Sweden Manage  Postcode");
			Thread.sleep(5000);
		...
		else if (Countrylist.equals("Switzerland"))
		{
			...
			System.out.println("Clicked on Switzerland Manage  Postcode");
...
*/
			...
			throws Exception 
	{
		...
		compareText("ManageColt", "Cancel", "Cancelbtn", "Cancel", xml);
		 ...
		 try {
				...
				if(ActNtServicemsg) {
					System.out.println("Success Message mismatches");
		...
		DriverTestcase.logger.log(LogStatus.PASS, "File uploaded");
		 ...
		 safeJavaScriptClick(getwebelement(
			 ...
			 System.out.println("Clicked on OK button");
				...
				if(ActNtServicemsg) {
					System.out.println("Success Message displays");
	...
	public void verifyDownloadNt(String application)throws Exception
	{
		...
		System.out.println("Clicked on Download Nt Service Area link");
	...
	public void verifyUploadupdatefile (String application, String filepath)
		...
		try {	
			...
			if(successmEssage_UploadUpdateFile) {
				...
				System.out.println("upload success message is displaying");
			}else {
				click_commonMethod(application, "cancel", "Cancelbtn" , xml);
			}
		}catch(Exception e) {
	 	...
	 	public static void editRecord(String filepath, String editTerm, String newId, String newName) {
			...
			try {
				...
				while(s.hasNext())
				{
					...
					{
						System.out.println("inside else cse");
//						pw.println(newId + "," + newName);
					}
				}
				...
				System.out.println("olf file  "+ oldfile);
				...
				System.out.println("dump path is "+dump);
