...
public class APT_MCS_CreateAccessCoreDevice_AccessSwitch extends DriverTestcase {
	...
	@Test(description = "TC-01",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=0)
...
//	@Test(description = "TC-02",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=1)
	public void verifycreatedevicefields(Map<String, String> map) throws InterruptedException, DocumentException {
		...
		APT_CreateAccessSwitchDeviceHelper.get().verifycreatedevicefields("CreateAccessCoreDevice");
		
	}
	
	@Test(description = "TC-03",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=2)
	public void verifycreateAccessSwitchdevice(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifycreateAccessSwitchdevice");
	...
	public void verifyDeviceCreationMessagefor_AccessSwitchDevice() throws IOException, InterruptedException, DocumentException{
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceCreationMessagefor_AccessSwitchDevice");
		
	APT_CreateAccessSwitchDeviceHelper.get().verifyDeviceCreationMessage("CreateAccessCoreDevice");
	
	}
	
	@Test(description = "TC-04",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=4)
	...
	@Test(description = "TC-05",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=5)
	public void verifyAccessSwitchdeviceEdit(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyAccessSwitchdeviceEdit");
	...
	@Test(description = "TC-06",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=6)
	public void verifyDeviceUpdationSuccessMessagefor_AccessSwitchDevice(Map<String, String> map) throws IOException, InterruptedException, DocumentException{
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessagefor_AccessSwitchDevice");
	...
	@Test(description = "TC-07",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=7)
	...
	@Test(description = "TC-08",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=8)
	...
	@Test(description = "TC-09",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=9)
	...
	@Test(description = "TC-010",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=10)
	...
	@Test(description = "TC-11",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_AccessSwitch_Device", priority=11)
