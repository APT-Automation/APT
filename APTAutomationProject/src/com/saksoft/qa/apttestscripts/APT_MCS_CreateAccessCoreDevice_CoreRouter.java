...
public class APT_MCS_CreateAccessCoreDevice_CoreRouter extends DriverTestcase {
...
//	@Test(description = "TC-02",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=1)
	public void verifycreatedevicefields(Map<String, String> map) throws InterruptedException, DocumentException {
		...
		APT_CreateCoreRouterDeviceHelper.get().verifycreatedevicefields("CreateAccessCoreDevice");
		
	}
	
	@Test(description = "TC-03",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=2)
	public void verifycreateCoreRouterdevice(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifycreateCoreRouterdevice");
	...
	public void verifyDeviceCreationMessagefor_coreRouterDevice() throws IOException, InterruptedException, DocumentException{
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceCreationMessagefor_AccessRouterDevice");
		
	APT_CreateCoreRouterDeviceHelper.get().verifyDeviceCreationMessage("verifyDeviceCreationMessagefor_coreRouterDevice");
	
	}
	
	@Test(description = "TC-04",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=4)
	...
	@Test(description = "TC-05",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=5)
	public void verifyCoreRouterdeviceEdit(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyCoreRouterdeviceEdit");
	...
	@Test(description = "TC-06",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=6)
	public void verifyDeviceUpdationSuccessMessagefor_coreRouterDevice(Map<String, String> map) throws IOException, InterruptedException, DocumentException{
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessagefor_coreRouterDevice");
		
	APT_CreateCoreRouterDeviceHelper.get().verifyDeviceUpdationSuccessMessage("CreateAccessCoreDevice");
	
	}

	@Test(description = "TC-07",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=7)
	...
	@Test(description = "TC-08",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=8)
	...
	@Test(description = "TC-09",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=9)
	...
	if(vendorModel.startsWith("Cisco")) {
		if(managementAddressEdit.equalsIgnoreCase("null")) {
			...
			APT_CreateCoreRouterDeviceHelper.get().routerPanel("CreateAccessCoreDevice", map.get("command_ipv4"), map.get("command_ipv6"), managementAddressCreated ,
					map.get("vrf_Ipv4"), map.get("vrf_Ipv6"));
		}
		else {
			APT_CreateCoreRouterDeviceHelper.get().routerPanel("CreateAccessCoreDevice", map.get("command_ipv4"), map.get("command_ipv6"), managementAddressEdit,
					map.get("vrf_Ipv4"), map.get("vrf_Ipv6"));
	...
	@Test(description = "TC-010",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=10)
	...
	//Snmpro
		...
		APT_CreateCoreRouterDeviceHelper.get().fetchDeviceInterface_viewdevicepage("CreateAccessCoreDevice");
	...
	@Test(description = "TC-11",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_CoreRouter_Device", priority=11)
	public void verifyCoreRouterdeviceDelete(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
