...
//	@Test(description = "TC-02",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=1)
	public void verifycreatedevicefields(Map<String, String> map) throws InterruptedException, DocumentException {
		...
		APT_CreatePrizmnetDeviceHelper.get().verifycreatedevicefields("CreateAccessCoreDevice");
		
	}
	
	@Test(description = "TC-03",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=2)
	public void verifycreateaPrizmnetdevice(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifycreateaPrizmnetdevice");
	...
	public void verifyDeviceCreationMessagefor_PrizmnetDevice() throws IOException, InterruptedException, DocumentException{
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceCreationMessagefor_PrizmnetDevice");
		
	APT_CreatePrizmnetDeviceHelper.get().verifyDeviceCreationMessage("CreateAccessCoreDevice");
	
	}
	
	@Test(description = "TC-04",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=4)
	...
	@Test(description = "TC-05",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=5)
	public void verifyPrizmnetdeviceEdit(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyPrizmnetdeviceEdit");
	...
	@Test(description = "TC-06",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=6)
	public void verifyDeviceUpdationSuccessMessagefor_PrizmnetDevice(Map<String, String> map) throws IOException, InterruptedException, DocumentException{
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessagefor_PrizmnetDevice");
		
	APT_CreatePrizmnetDeviceHelper.get().verifyDeviceUpdationSuccessMessage("CreateAccessCoreDevice");
	
	}

	@Test(description = "TC-07",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=7)
	...
	@Test(description = "TC-08",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=8)
	...
	@Test(description = "TC-09",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=9)
	...
	@Test(description = "TC-010",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=10)
	...
	@Test(description = "TC-11",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_Prizmnet_Device", priority=11)
