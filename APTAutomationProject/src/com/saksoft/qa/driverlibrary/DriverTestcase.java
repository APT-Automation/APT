...
//				capabilities.setCapability(FirefoxOptions.CAPABILITY, options2);
		...
		//extent = new ExtentReports ("C:/Automation/ExtentReports/SS_ExtentReport-"+dateName1+".html", true);
		extent = new ExtentReports (System.getProperty("user.dir") +"/ExtentReports/"+"SS_ExtentReport-"+dateName1+".html", true);
		extent.addSystemInfo("Host Name", "APT_QA_Colt").addSystemInfo("Environment", "QA").addSystemInfo("User Name", "Sai12345");
		 }
