...
public class APT_CreateAccessCoreDevice_ManageNetworkHelper extends DriverHelper {

	public APT_CreateAccessCoreDevice_ManageNetworkHelper(WebDriver dr) {
		super(dr);
...
//	public static String InterfaceAddress;
	public void managenetwork(String application, String devicename, String Inservice_status, String Inmaintenance_status, String vendormodel,
			String managementaddress, String snmpro, String country, String city, String site, String premise, String interfacename)
					throws InterruptedException, DocumentException, ParseException, IOException {
//		
...
//			
//			String City=getwebelement(xml.getlocator("//locators/" + application + "/statuspage_cityvalue")).getText();
//			DriverTestcase.logger.log(LogStatus.PASS, "City Value is: "+City);
//			
//			String Site=getwebelement(xml.getlocator("//locators/" + application + "/statuspage_sitevalue")).getText();
//			DriverTestcase.logger.log(LogStatus.PASS, "Site Value is: "+Site);
//			
//			String Premise=getwebelement(xml.getlocator("//locators/" + application + "/statuspage_premisevalue")).getText();
//			DriverTestcase.logger.log(LogStatus.PASS, "Site Value is: "+Premise);
//			
...
//						try {
//
//							String AddedInterface = results.get(i).getText();
//							System.out.println(AddedInterface);
//							if (AddedInterface.equalsIgnoreCase(interfacename)) {
//
