...
public class APT_MCS_CreatePrizmnetDeviceHelper extends DriverHelper{

	public APT_MCS_CreatePrizmnetDeviceHelper(WebDriver dr) {
		super(dr);
 ...
 public void verifyDeviceUpdationSuccessMessage(String application) throws IOException, InterruptedException, DocumentException {
	...
	//Device Type
 		...
 		if(devicetype.equalsIgnoreCase("Prizmnet")) {
