...
//
//
public class APT_MCS_CreateAccessCoreDevice_LoadBalancer extends DriverTestcase {
	

	@Test(description = "TC-01",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=0)
	public void verifynavigationtocreatedevicepage(Map<String, String> map) throws InterruptedException, DocumentException {
		...
		APT_CreateLoadBalancerDeviceHelper.get().navigatetocreateaccesscoredevicepage("CreateAccessCoreDevice");
	}
	
	
//	@Test(description = "TC-02",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=1)
	public void verifycreatedevicefields(Map<String, String> map) throws InterruptedException, DocumentException {
		...
		APT_CreateLoadBalancerDeviceHelper.get().verifycreatedevicefields("CreateAccessCoreDevice");
		
	}
	
	@Test(description = "TC-03",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=2)
	public void createLoadBalancerdevice(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		DriverTestcase.logger = DriverTestcase.extent.startTest("createLoadBalancerdevice");
		
		APT_CreateLoadBalancerDeviceHelper.get().verifydevicecreation_AccessRouter("CreateAccessCoreDevice", map.get("Name"), map.get("DeviceType"), map.get("VendorModel"),map.get("Modular MSP"), 
	...
	public void verifyDeviceCreationMessagefor_LoadBalancerDevice() throws IOException, InterruptedException, DocumentException{
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceCreationMessagefor_LoadBalancerDevice");
		
	APT_CreateLoadBalancerDeviceHelper.get().verifyDeviceCreationMessage("CreateAccessCoreDevice");
	
	}
	
	@Test(description = "TC-04",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=4)
	public void verifyEnteredValueForDevice(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		...
		APT_CreateLoadBalancerDeviceHelper.get().verifyenteredValue_forDeviceCreation("CreateAccessCoreDevice", map.get("Name"), map.get("DeviceType"), map.get("VendorModel"),map.get("Modular MSP"), 
				map.get("Full IQNET"), map.get("IOSXR"), map.get("Telnet"), map.get("SSH"), map.get("Snmp2C"), map.get("SnmPro"), map.get("Snmprw"), 
				map.get("SnmProNewValue"), map.get("SnmprwNewValue"), map.get("Snmp3"), map.get("Snmpv3Username"),
				map.get("Snmpv3Authpassword"), map.get("Snmpv3Privpassword"), map.get("Snmpv3UsernameNewValue"), 
				map.get("Snmpv3AuthpasswordNewValue"), map.get("Snmpv3PrivpasswordNewValue"), map.get("RouterID"),
	...
	@Test(description = "TC-05",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=5)
	public void editLoadBalancerDevice(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		DriverTestcase.logger = DriverTestcase.extent.startTest("editLoadBalancerDevice");
		
		APT_CreateLoadBalancerDeviceHelper.get().verifydeviceEdit_AccessRouter("CreateAccessCoreDevice", map.get("editdeviceName"), map.get("DeviceType"),
	...
	@Test(description = "TC-06",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=6)
	public void verifyDeviceUpdationSuccessMessagefor_LoadBalancerevice(Map<String, String> map) throws IOException, InterruptedException, DocumentException{
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyDeviceUpdationSuccessMessagefor_LoadBalancerevice");
		
	APT_CreateLoadBalancerDeviceHelper.get().verifyDeviceUpdationSuccessMessage("verifyDeviceUpdationSuccessMessagefor_FirewallDevice");
	
	}
	
	
	@Test(description = "TC-07",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=7)
	public void verifyUpdatedValueForDevice(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyEnteredValueForDevice");
		
		APT_CreateLoadBalancerDeviceHelper.get().verifEditedValue_Firewall("CreateAccessCoreDevice", map.get("editdeviceName"), map.get("DeviceType"),
				map.get("editVendorModel"), map.get("editRouterID"), map.get("editModularMSP"), map.get("editFullIQNET"), map.get("editIOSXR"), map.get("editTelnet"),
				map.get("editSSH"), map.get("editSnmp2C"), map.get("editSnmp3"), map.get("editSnmProNewValue"), map.get("editSnmprwNewValue"), map.get("editSnmpv3UsernameNewValue"),
				map.get("editSnmpv3AuthpasswordNewValue"), map.get("editSnmpv3PrivpasswordNewValue"),map.get("editManagementAddress"), map.get("editCountry"), map.get("editExistingCity"),
				map.get("editExistingCityValue"), map.get("editExistingSite"), map.get("editExistingSiteValue"), map.get("editExistingPremise"), map.get("editExistingPremiseValue"),
	...
	@Test(description = "TC-08",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=8)
	public void verifyTestCommandAndStatus(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		...
		APT_CreateLoadBalancerDeviceHelper.get().testStatus("CreateAccessCoreDevice");
	
	}
	
	@Test(description = "TC-09",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=9)
	...
	if(vendorModel.startsWith("Cisco")) {
		if(managementAddressEdit.equalsIgnoreCase("null")) {
			...
			APT_CreateLoadBalancerDeviceHelper.get().routerPanel("CreateAccessCoreDevice", map.get("command_ipv4"), map.get("command_ipv6"), managementAddressCreated ,
					map.get("vrf_Ipv4"), map.get("vrf_Ipv6"));
		}
		else {
			APT_CreateLoadBalancerDeviceHelper.get().routerPanel("CreateAccessCoreDevice", map.get("command_ipv4"), map.get("command_ipv6"), managementAddressEdit,
					map.get("vrf_Ipv4"), map.get("vrf_Ipv6"));
	...
	@Test(description = "TC-10",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=10)
	...
	//Snmpro
		...
		APT_CreateLoadBalancerDeviceHelper.get().fetchDeviceInterface_viewdevicepage("CreateAccessCoreDevice");
	...
	@Test(description = "TC-11",dataProviderClass = DataReader_PK.class, dataProvider = "DataReader_LoadBalancer_Device", priority=11)
	public void verifyLoadBalancerdeviceDeleteFunctionality(Map<String, String> map) throws InterruptedException, IOException, DocumentException {
		
		DriverTestcase.logger = DriverTestcase.extent.startTest("verifyLoadBalancerdeviceDeleteFunctionality");
		
		
		APT_CreateLoadBalancerDeviceHelper.get().verifydeviceDelete_AccessRouter("CreateAccessCoreDevice");
