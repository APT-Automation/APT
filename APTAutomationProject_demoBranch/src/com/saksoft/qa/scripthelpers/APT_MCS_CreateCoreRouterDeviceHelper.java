...
public class APT_MCS_CreateCoreRouterDeviceHelper extends DriverHelper{
	...
	public APT_MCS_CreateCoreRouterDeviceHelper(WebDriver dr) {
		super(dr);
    ...
    public void verifyenteredValue_forDeviceCreation(String application, String name, String devicetype, 
       ...
       //Device Name	
        ...
        //Connectivity protocol
        	if((telnet.equalsIgnoreCase("Yes")) && (ssh.equalsIgnoreCase("No"))){
        		verifyEnteredvalues("Connectivity Protocols", "telnet");
        	}
        	else if((telnet.equalsIgnoreCase("no")) && (ssh.equalsIgnoreCase("Yes"))){
        		verifyEnteredvalues("Connectivity Protocols", "ssh");
        	}
        ...
        //SNMP Version
        	if((snmp2c.equalsIgnoreCase("Yes")) && (snmp3.equalsIgnoreCase("No"))) {
        		...
        		if(snmpro2cvalue.equalsIgnoreCase("null")) {
        			verifyEnteredvalues("Snmpro", "incc");
        		}else {
        			verifyEnteredvalues("Snmpro", snmpro2cvalue);
        		}
        		
        		//Snmprw
        		if(snmprw2cvalue.equalsIgnoreCase("null")) {
        			verifyEnteredvalues("Snmprw", "ip4corp3");
        		}else {
        			verifyEnteredvalues("Snmprw", snmprw2cvalue);
        		}
        		...
        		if(Snmpv3Usernamevalue.equalsIgnoreCase("Null")) {
        			verifyEnteredvalues("Snmp v3 Username", "colt-nms");
        		}else {
        			verifyEnteredvalues("Snmp v3 Username", Snmpv3Usernamevalue);
        		}
        			
        			
        		//Snmp v3 Auth Password
        			if(Snmpv3Authpasswordvalue.equalsIgnoreCase("null")) {
        				verifyEnteredvalues("Snmp v3 Auth password", "OrHzjWmRvr4piJZb");
        			}else {
        				verifyEnteredvalues("Snmp v3 Auth password", Snmpv3Authpasswordvalue);
        			}
        			
        			
        		//Snmp v3 Priv Password
        			if(Snmpv3Privpasswordvalue.equalsIgnoreCase("Null")) {
        				verifyEnteredvalues("Snmp v3 Priv password", "3k0hw8thNxHucQkE");
        			}else {
        				verifyEnteredvalues("Snmp v3 Priv password", Snmpv3Privpasswordvalue);
        			}
 ...
 public void verifyDeviceUpdationSuccessMessage(String application) throws IOException, InterruptedException, DocumentException {
	...
	if((editTelnet.equalsIgnoreCase("null")) && (editSSH.equalsIgnoreCase("null"))) {
		...
		System.out.println(" No changes made for 'Connectivity Protocol' as expected");
	...
	if((editSnmp2C.equalsIgnoreCase("null"))  && (editSnmp3.equalsIgnoreCase("null"))) {
		...
		System.out.println("No changes made for 'SNMP Version' as expected");
	...
	public void verifyEnteredvalues(String label, String expectedValue) throws InterruptedException {
		...
		try {
			...
			if ((valueinfo.equals("")) || (valueinfo.equalsIgnoreCase(null)) || (valueinfo.equals(" "))) {
				...
				if(expectedValue.equalsIgnoreCase(valueinfo)) {
					...
					DriverTestcase.logger.log(LogStatus.PASS, "Step : value displayed for" + label + "is : " + valueinfo+". Expected value is: "+expectedValue);
				}
					...
					System.out.println("the values are not dipslaying as expected for label: "+label);
					DriverTestcase.logger.log(LogStatus.FAIL, " Value is not displaying as expected in 'view' page for "+ label);
					DriverTestcase.logger.log(LogStatus.FAIL, "Step : value displayed for " + label + "is : " + valueinfo+". Expected value is: "+expectedValue);
	  ...
	  public void editPremise(String application, String editExistingPremise, String editNewPremise, String dropdown_xpath, String selectPremiseToggleButton,
	    	...
	    	if(editExistingPremise.equalsIgnoreCase("yes") & editNewPremise.equalsIgnoreCase("no")) {
	    		...
	    		existingSite(application, dropdown_xpath, dropdownValue, selectPremiseToggleButton, labelname);
				...
				newSite(application, dropdown_xpath, addPremisetoggleButton, editNewPremiseName, editNewPremiseCode, labelname);
