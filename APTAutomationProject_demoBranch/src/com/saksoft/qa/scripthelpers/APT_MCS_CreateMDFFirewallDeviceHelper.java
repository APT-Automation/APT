...
public class APT_MCS_CreateMDFFirewallDeviceHelper extends DriverHelper{

	public APT_MCS_CreateMDFFirewallDeviceHelper(WebDriver dr) {
		super(dr);
 ...
 public void verifyDeviceUpdationSuccessMessage(String application) throws IOException, InterruptedException, DocumentException {
	...
	//Device Type
 		...
 		if(devicetype.equalsIgnoreCase("MDF Firewall")) {
